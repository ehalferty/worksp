...
#定时数据  
def getTimerCode():  
    timerCode = lowLevel+lowLevel+lowLevel+lowLevel+lowLevel+lowLevel+lowLevel+lowLevel  
    return timerCode  
...
def getOtherFunc2():  
    ...
    otherFunc2+= lowLevel+lowLevel+lowLevel+lowLevel+lowLevel+lowLevel+lowLevel+lowLevel+lowLevel+lowLevel+lowLevel+lowLevel  
    return otherFunc2  
