...
xst -ifn xst.scr
mv xilinx_pci_exp_4_lane_ep.ngc ./results/pcie_blk_plus_v1_2_top.ngc
...
ngdbuild \
  -verbose \
  -uc ../../example_design/xilinx_pci_exp_blk_plus_4_lane_ep-XC5VLX50T-FF1136-1.ucf \
