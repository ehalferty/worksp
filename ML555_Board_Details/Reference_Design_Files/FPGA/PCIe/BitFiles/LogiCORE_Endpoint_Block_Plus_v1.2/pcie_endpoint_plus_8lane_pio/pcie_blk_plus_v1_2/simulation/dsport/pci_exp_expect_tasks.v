...
`define EXPECT_CPLD_PAYLOAD `BOARD.`XILINX_PCI_EXP_DOWNSTREAM_PORT_INST.tx_usrapp.expect_cpld_payload
`define EXPECT_MEMWR_PAYLOAD `BOARD.`XILINX_PCI_EXP_DOWNSTREAM_PORT_INST.tx_usrapp.expect_memwr_payload
`define EXPECT_MEMWR64_PAYLOAD `BOARD.`XILINX_PCI_EXP_DOWNSTREAM_PORT_INST.tx_usrapp.expect_memwr64_payload
