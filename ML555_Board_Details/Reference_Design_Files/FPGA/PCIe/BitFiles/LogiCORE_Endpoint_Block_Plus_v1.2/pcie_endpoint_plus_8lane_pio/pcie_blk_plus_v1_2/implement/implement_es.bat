...
copy xdlmod.pl .\results\.

echo 'Synthesizing verilog example design with XST';
xst -ifn xst.scr
move xilinx_pci_exp_8_lane_ep.ngc .\results\pcie_blk_plus_v1_2_top.ngc

cd results

echo 'Running ngdbuild'
  ngdbuild -verbose -uc ..\..\example_design\xilinx_pci_exp_blk_plus_8_lane_ep-XC5VLX50T-FF1136-1_ES_ML555.ucf pcie_blk_plus_v1_2_top.ngc -sd ..\..\..\
...
echo 'Running design through netgen'
  netgen -sim -ofmt verilog -ne -w -tm xilinx_pci_exp_8_lane_ep -sdf_path ..\..\implement\results routed.ncd
