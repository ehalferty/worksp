...
`define EXPECT_FINISH_CHECK `BOARD.`XILINX_PCI_EXP_DOWNSTREAM_PORT_INST.tx_usrapp.expect_finish_check
  ...
  case (trn_rx_state)
    ...
    `TRN_RX_IDLE : begin
      ...
      if (trn_reset_n == 1'b0)
        ...
        if (  (trn_rsof_n == 1'b0) &&
          ...
          `BOARD.`XILINX_PCI_EXP_DOWNSTREAM_PORT_INST.com_usrapp.TSK_READ_DATA(0, `RX_LOG, trn_rd, trn_rrem_n);
    ...
    `TRN_RX_ACTIVE : begin
      ...
      if (trn_reset_n == 1'b0)
        ...
        `BOARD.`XILINX_PCI_EXP_DOWNSTREAM_PORT_INST.com_usrapp.TSK_READ_DATA(1, `RX_LOG, trn_rd, trn_rrem_n);
        `BOARD.`XILINX_PCI_EXP_DOWNSTREAM_PORT_INST.com_usrapp.TSK_PARSE_FRAME(`RX_LOG);
